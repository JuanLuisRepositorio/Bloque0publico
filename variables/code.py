#N�meros
#Python soporta dos tipos de n�meros - integrales y numeros de punto flotante. (Tambien soporta n�meros complejos, los cuales no se explicar�n en este tutorial).

#Para definir un integral, usa la siguiente sintaxis:

myint = 7
#Para definir un n�mero de punto flotante, debes usar una de las siguientes notaciones:
